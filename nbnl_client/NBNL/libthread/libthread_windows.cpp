...
thread_t * thread_getCurrentThread(void) {
    thread_t * th = (thread_t *)malloc(sizeof(struct thread_s));
...
thread_t * thread_create_args(thread_func_t func, void * args) {
	thread_t * t = (thread_t *)malloc(sizeof(struct thread_s));
    t->result = (void *)NULL;

    _thread_input_args_t * wrapped_args = (_thread_input_args_t *)malloc(sizeof(_thread_input_args_t));
...
mutex_t * mutex_new(void) {
    mutex_t * ins = (mutex_t *)malloc(sizeof(struct mutex_s));
