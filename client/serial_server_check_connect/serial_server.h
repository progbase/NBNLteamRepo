...
typedef enum SERIAL_SERVER_STATUS {SERIAL_SERVER_OK, SERIAL_SERVER_SEND_ERROR, SERIAL_SERVER_READ_ERROR, CEATING_FILE_ERROR} serial_server_status;
SERIAL_SERVER_STATUS getLastError();

serial_server_t * serial_server_new(int com_port, serial_server_status * status);
